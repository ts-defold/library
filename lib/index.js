...
yargs_1.default
    ...
    const out = path_1.default.resolve((_b = process.env.INIT_CWD) !== null && _b !== void 0 ? _b : process.cwd(), argv.out);
    ...
    var _a, _b;
    const src = path_1.default.resolve((_a = process.env.INIT_CWD) !== null && _a !== void 0 ? _a : process.cwd(), argv.src);
    const out = path_1.default.resolve((_b = process.env.INIT_CWD) !== null && _b !== void 0 ? _b : process.cwd(), "./@types");
